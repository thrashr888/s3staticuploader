...
print "Usage: policy.py BUCKET_NAME AWS_ACCESS_KEY AWS_SECRET_KEY [KEY] [MAX_MEGABYTES] [ACL]\n"
...
content_length_range = int(float(sys.argv[5]) * 1048576) if sys.argv.__len__() >= 6 else 5242880  # 5mb default. convert to bytes.
